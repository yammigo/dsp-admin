  ...
  methods: {
    ...
    r (e, t) {
      ...
      var i = '',
        n = Math.floor(e / 2),
        a = e % 2
      return t === 'end' && a === 1 && (n += 1),
      i += n <= 9 ? '0' + n : n,
      i += t === 'start' ? a === 1 ? ':30' : ':00' : a === 0 ? ':30' : ':00'
    },
    ...
    setFirstSource: function (e, t, i) {
      var n = this.value[e]
      this.isAdd = !n || n.indexOf(t) === -1,
      i.which === 1 && (this.start_td = i.target,
    ...
    getSelectedCollection: function (e, t, i, n) {
      ...
      this.$refs.calendarAtomTime.forEach(function (r) {
        ...
        a.value[s].push(o)),
        a.value[s] && (a.isAdd ? l === -1 && a.value[s].push(o) : l > -1 && a.value[s].splice(l, 1)))
      }),
      this.$emit('input', this.value),
      this.changeTimeStr(t, n)
    },
    changeTimeStr: function (e, t) {
      for (var i = e; i <= t; i++) { this.transformTimeArrToString(this.value[i], i) }
    },
    initiateTimePeriodStr: function () {
      for (var e = 0; e < this.value.length; e++) { this.value[e].length !== 0 && this.transformTimeArrToString(this.value[e], e) }
    },
    sortArr: function (e) {
    ...
    transformTimeArrToString: function (e, t) {
      var i = this.sortArr(e),
        ...
        o = n.map((e) => {
          var t = void 0,
            i = this.r(e[0], 'start')
          return e.length === 1 ? t = this.r(e[0] + 1, 'start') : e.length === 2 && (t = this.r(e[1], 'end')),
          [i, t].join('~')
        }).join('、')
      console.log(o)
    ...
    value: {
      ...
      handler: function (e, t) {
        ...
        this.weekCheckbox.map(function (e, t) {
          ...
          n === 48 ? i.weekCheckbox.splice(t, 1, !0) : i.weekCheckbox.splice(t, 1, !1),

...
<div class="content_main">
    ...
    <Modal v-model="showModal" title="新增" :mask-closable="false" width="650">
    ...
    <!-- 修改 -->
    <Modal v-model="modifyModal" title="修改" :mask-closable="false" width="650">
    ...
    <!--分配角色-->
    <Modal v-model="setUserRoleModal" title="分配角色" :mask-closable="false" width="800">
        <section>
    ...
    <!-- 管理下游用户 -->
    <Modal v-model="downstreamModal" title="管理下游" :mask-closable="false" width="800">
        <Row>
        ...
        <Transfer class="margin-top-20" :data="downstreamUserList" :target-keys="targetKeys" :titles="['全部用户', '已选用户']" filterable :filter-method="filterMethod" :list-style="{width: '350px', height: '450px'}" @on-change="handleChange"></Transfer>
        <div slot="footer">
    ...
    <!-- 管理上游广告主 -->
    <Modal v-model="upstreamModal" title="管理上游广告主" :mask-closable="false" width="800">
        <Row>
        ...
        <Transfer class="margin-top-20" :data="uptreamSourceList" :target-keys="sourceTargetKeys" :titles="['全部用户', '已选用户']" filterable :filter-method="filterMethod" :list-style="{width: '350px', height: '450px'}" @on-change="handleChange2"></Transfer>
        <div slot="footer">
...
export default {
  ...
  methods: {
    ...
    // 修改保存
    modifyDataOk () {
      if (this.modifyDataInfo.pswd !== '') {
        this.modifyDataInfo.pswd = md5(this.modifyDataInfo.pswd)
      }
